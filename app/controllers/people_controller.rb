...
class PeopleController < ApplicationController
  ...
  before_filter :authorize_people, :except => [:avatar, :context_menu, :bulk_edit, :bulk_update, :autocomplete_tags, :manager, :autocomplete_for_manager, :add_manager]

  before_filter :bulk_find_people, :only => [:context_menu, :bulk_edit, :bulk_update]
